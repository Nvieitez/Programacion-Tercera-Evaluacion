...
// IMPORTS ------------------------------------------------------------------------------------------------------------------------------------------
    ...
    // Importamos la clase "FuncionalidadGestiónClases" para poder usar sus métodos y sus funcionalidades.
    import Funcionalidades.FuncionalidadGestionClases;

    // Importamos la clase "FuncionalidadGestiónEquipos" para poder usar sus métodos y sus funcionalidades.
    import Funcionalidades.FuncionalidadGestionPeleas;
...
// COMIENZO DEL CÓDIGO ------------------------------------------------------------------------------------------------------------------------------
    ...
    public static void MétodoMenúPrincipal(){
        ...
        JFrame FrameMenúPrincipal = new JFrame();
            ...
            // Título
            FrameMenúPrincipal.setTitle("Simulador Elden Ring");
        ...
        JPanel PanelMenúPrincipal = new JPanel();
            ...
            JButton BotónGestionarClases = new JButton();

                // Determinamos los ajustes del "JButton".

                // Texto
                BotónGestionarClases.setText("Cambia la clase de tu personaje");

                // Tamaño
                BotónGestionarClases.setSize(250, 100);

                // Localización
                BotónGestionarClases.setLocation(10, 10);

                // Visibilidad 
                BotónGestionarClases.setVisible(true);

            // Ahora vamos a crear un "ActionListener" para que el botón actúe a las acciones del usuario.
            BotónGestionarClases.addActionListener(new ActionListener() {
                ...
                public void actionPerformed(ActionEvent AcciónBotónGestionarClases){

                    // Aquí vamos a llamar a la clase "FuncionalidadGestiónClases", esta contiene todo el sistema lógico.
                    FuncionalidadGestionClases.MétodoGestiónClases();
            ...
            PanelMenúPrincipal.add(BotónGestionarClases);
            ...
            JButton BotónGestionarEquipos = new JButton();
                ...
                // Texto
                BotónGestionarEquipos.setText("Pelea contra duros enemigos!");
            ...
            BotónGestionarEquipos.addActionListener(new ActionListener() {
                ...
                public void actionPerformed(ActionEvent AcciónBotónGestionarEquipos){
                   ...
                   FuncionalidadGestionPeleas.MétodoGestiónPeleas();
            ...
            JLabel LabelMenúPrincipal = new JLabel();
                ...
                // Imagen
                LabelMenúPrincipal.setIcon(new ImageIcon("10- ProyectoEldenRing/src/Imágenes/ImagenMenúPrincipal.jpg"));
